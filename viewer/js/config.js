function config() {
    return {
            ...
            cellData: 'https://api.github.com/repos/acycliq/ca1/contents/viewer/data/dev/cellData',
            geneData: 'https://api.github.com/repos/acycliq/ca1/contents/viewer/data/dev/geneData',
            cellBoundaries: 'https://api.github.com/repos/acycliq/ca1/contents/viewer/data/dev/cellBoundaries',

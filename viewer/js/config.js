...
// 4. size is the tsv size in bytes.  Not crucial if you dont get it right, ie the full tsv will
//    still be parsed despite this being wrong. It is used by the loading page piecharts to calc
//    how far we are.
...
function config() {
    return {
            ...
            layers: {'dapi': 'https://storage.googleapis.com/ca1-data/img/262144px/{z}/{y}/{x}.jpg',
